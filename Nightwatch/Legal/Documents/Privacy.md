...
| Anonymous usage events | PostHog | Product analytics |
...
Analytics and subscription data are retained only as long as needed for the
purposes above, or as required by law. Location data is not retained by us at
all, because we never receive it.
